...
## Design Tokens (from style tile)
 
- **Typefaces:** Archivo (headings, `font-sans`) · IBM Plex Sans (body copy, `font-body`)
- **Palette:** Accent/EA Green `#4AAC07` (hover shade `#3A8A06`) · Charcoal `#1D211C` · Mid grey/muted `#5A625A` · Cool grey/background `#F4F6F3` · Surface `#FFFFFF` · Border `#C6CCC4` (unconfirmed against style tile, carried over from initial scaffold)
- **Type scale:** H1 38px · H2 26px · H3 19px · Body 16px · Meta/caption 13px
...
- Buttons: filled accent (primary), accent-dark on hover, outline-accent (secondary, e.g. "Browse FAQs")
- Topic category chips: filled accent pill (active state) vs. outline-accent pill (default)
All tokens live in `tailwind.config.mjs` theme values — do not hardcode hex values in components.
